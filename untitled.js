...
function draw(c){
    for(d=0; d<stack_of_steps[c].length; d++){
        ctx2.fillRect(stack_of_steps[c][d].y, stack_of_steps[c][d].x, stack_of_steps[c][d].lineThickness , stack_of_steps[c][d].lineThickness );
    }
}